...
.. code:: bash
    ...
    gear2 = ot.Gear(5, I=5, R=150, parent=gear_parent)  # child gear


4. Assembly
-----------
Assembly represents a complete system model. ``Assembly`` takes as parameters lists which contain all elements of one type each.
...
Assembly can be visualized using openTorsion plotting tools. ``Plots`` takes as parameter the created assembly.
