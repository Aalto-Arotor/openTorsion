...
class Induction_motor():
    ...
    def __init__(
        ...
        self.omega_r = self.omega_s - self.omega_m          # Rotor speed relative to synchronous coordinates
    ...
    def get_currents(self):
        ...
        denominator = np.complex(-S*L_r*L_s*omega_s**2+L_m**2*omega_s**2*S+ R_r*R_s, S*L_r*R_s*omega_s+L_s*R_r*omega_s)
