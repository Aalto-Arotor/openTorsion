...
def get_dyrobes_response():
    ...
    dyrobes_response = np.array(
        [
            [14.482758620689651, 69148.93617021292],
            [19.04640272456364, 132978.72340425476],
            [21.021711366538952, 180851.06382978708],
            [24.563644103873983, 324468.0851063831],
            [26.947637292464876, 468085.10638297815],
            [28.10557684120902, 595744.6808510637],
            [29.127288207747974, 739361.7021276588],
            [30.080885483184325, 898936.1702127652],
            [30.762026394210295, 1053191.4893617015],
            [31.170710940825877, 1218085.106382979],
            [31.64750957854406, 1367021.2765957443],
            [32.192422307364836, 1574468.0851063826],
            [32.8054491272882, 1856382.978723404],
            [33.07790549169859, 2095744.6808510632],
            [33.282247765006375, 2345744.680851063],
            [33.62281822051936, 2585106.382978723],
            [33.89527458492975, 2803191.4893617015],
            [34.09961685823754, 3042553.191489361],
            [34.37207322264793, 3319148.9361702125],
            [34.712643678160916, 3585106.382978723],
            [34.9851000425713, 3824468.0851063826],
            [35.46189868028948, 4148936.170212765],
            [35.1213282247765, 3984042.5531914886],
            [36.14303959131545, 3984042.5531914886],
            [36.27926777352064, 3776595.7446808508],
            [36.48361004682843, 3585106.382978723],
            [36.82418050234141, 3319148.9361702125],
            [37.0966368667518, 3122340.4255319145],
            [37.300979140059596, 2877659.5744680846],
            [37.70966368667518, 2563829.787234042],
            [38.186462324393354, 2297872.3404255314],
            [38.45891868880374, 2117021.2765957443],
            [39.00383141762451, 1851063.8297872338],
            [39.68497232865048, 1643617.0212765955],
            [40.63856960408685, 1436170.2127659568],
            [41.796509152830986, 1218085.106382979],
            [43.70370370370369, 1021276.5957446806],
            [45.20221370796083, 893617.0212765951],
            [46.90506598552576, 797872.3404255314],
            [48.335461898680286, 744680.8510638298],
            [50.0383141762452, 696808.5106382975],
            [51.87739463601532, 659574.4680851055],
            [53.716475095785434, 622340.4255319145],
            [56.6453810131971, 569148.9361702129],
            [58.893146019582794, 553191.4893617015],
            [61.209025117071086, 521276.5957446806],
            [64.00170285227756, 500000],
            [67.88420604512558, 473404.2553191483],
            [72.58407833120475, 454787.23404255323],
            [82.32439335887611, 425531.9148936169],
            [87.50106428267347, 414893.6170212766],
            [91.45168156662407, 409574.46808510646],
            [97.10515112813962, 409574.46808510646],
            [75.7173265219242, 457446.80851063784],
            [78.78246062154108, 425531.9148936169],
        ]
    )
...
def branched_drivetrain():
    ...
    disks.append(
        ot.Disk(9, I_high_pressure_turbine, c=d_high_pressure_turbine)
    )
...
def run_forced_response_analysis():
    ...
    lbin_to_Nm = 0.11298
    plt.plot(
        np.linspace(0.1, 100, n_steps),
        VT_sum_result[0] / 1000,
        c="C0",
        label="OpenTorsion",
    )
    plt.scatter(
        dyrobes_response[:, 0],
        dyrobes_response[:, 1] * lbin_to_Nm / 1000,
        c="C1",
        marker="x",
